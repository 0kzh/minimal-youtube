...
/**
 * The replaceHomePage function replaces the body of the page with a home page.
 * 
 *
 *
...
const replaceHomePage = () => {
  ...
  if (window.location.pathname === "/") {
    ...
    <div class="home-container">
      ...
      <div class="myYtButtonsContainer">
        <a class="myYtButton" href="https://www.youtube.com/feed/subscriptions"><span>My Subscriptions</span></a>
        <a class="myYtButton" href="https://www.youtube.com/playlist?list=LL"><span>Liked Videos</span></a>
        <a class="myYtButton" href="https://www.youtube.com/feed/history"><span>History</span></a>
      </div>   
    </div>
    `;
